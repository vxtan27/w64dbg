...
FORCEINLINE
NTSTATUS
TraceModuleEvent(LPDEBUG_EVENT lpDebugEvent, LPCSTR szDebugEventName, SIZE_T DebugEventNameLength, HANDLE hStdout)
{
...
FORCEINLINE
NTSTATUS
TraceDebugEvent(LPDEBUG_EVENT lpDebugEvent, LPCSTR szDebugEventName, SIZE_T DebugEventNameLength, HANDLE hStdout)
{
    IO_STATUS_BLOCK IoStatusBlock;
